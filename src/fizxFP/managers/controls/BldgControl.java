 ...
 * @author Computer
 */
public class BldgControl extends AbstractControl implements Savable, Cloneable {
     ...
     * @param bm
     */
    public BldgControl(BldgManager bm){
        this.bldgManager = bm;
    ...
    protected void controlUpdate(float tpf){
        if(spatial != null && bldgManager != null) {
    ...
    public Control cloneForSpatial(Spatial spatial){
        final BldgControl control = new BldgControl();
